...
import 'package:kudelia_pmp_laba_1/person.dart';
import 'package:kudelia_pmp_laba_1/weather.dart';
import 'package:kudelia_pmp_laba_1/weather_detail.dart';
import 'details.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final persons = <Person>[
    ...
    Person("Mikita Kudelia", "Bachelor"),
  ];
  ...
  void initState() {
    ...
    weatherInfo = fetchWeather("California");
